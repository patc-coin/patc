...
Audit reports are published in the `docs` folder: https://pc.dp.tc/tree/master/docs/audits 


| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `geth` | 20170425 | [pdf](https://pc.dp.tc/blob/master/docs/audits/2017-04-25_Geth-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://pc.dp.tc/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |
...
To find out how to disclose a vulnerability in pc visit [https://bounty.pc.dp.tc](https://bounty.pc.dp.tc) or email bounty@pc.dp.tc.
