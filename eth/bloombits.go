...
const (
	// bloomServiceThreads is the number of goroutines used globally by an pc
...
func (eth *pc) startBloomHandlers(sectionSize uint64) {
...
// for the pc header bloom filters, permitting blazing fast filtering.
