...
func makeMiner(genesis *core.Genesis) (*node.Node, *eth.pc, error) {
	// Define the basic configurations for the pc node
	...
	// Create the node and configure a full pc node on it
