...
func (mc *mockCaller) CallContract(ctx context.Context, call pc.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call pc.CallMsg) ([]byte, error) {
