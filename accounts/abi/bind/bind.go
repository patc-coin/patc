...
// Package bind generates pc contract Go bindings.
//
// Detailed usage document and tutorial available on the go-pc Wiki page:
// https://pc.dp.tc/wiki/Native-DApps:-Go-bindings-to-pc-contracts
package bind
