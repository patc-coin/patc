...
!define HELPURL "https://pc.dp.tc/issues"
!define UPDATEURL "https://pc.dp.tc/releases"
!define ABOUTURL "https://pc.dp.tc#pc-go"
...
Section "Geth" GETH_IDX
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "pc" 30303 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "pc" "" 30303 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "pc" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/pc/EIPs/issues/147)
  ${EnvVarUpdate} $0 "pc_SOCKET" "R" "HKLM" "\\.\pipe\geth.ipc"
  ${EnvVarUpdate} $0 "pc_SOCKET" "A" "HKLM" "\\.\pipe\geth.ipc"
