...
// setting up a new or managing an existing pc private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your pc private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new pc network down to  |")
	...
	log.Info("Administering pc network", "name", w.network)
