...
import (
	_ "pc.dp.tc/crypto/secp256k1/libsecp256k1/include"
	_ "pc.dp.tc/crypto/secp256k1/libsecp256k1/src"
	_ "pc.dp.tc/crypto/secp256k1/libsecp256k1/src/modules/recovery"
)
