...
import (
	...
	"pc.dp.tc/crypto"
	"pc.dp.tc/crypto/blake2b"
	"pc.dp.tc/crypto/bls12381"
	"pc.dp.tc/crypto/bn256"
	"pc.dp.tc/params"
...
// PrecompiledContractsHomestead contains the default set of pre-compiled pc
...
// PrecompiledContractsByzantium contains the default set of pre-compiled pc
...
// PrecompiledContractsIstanbul contains the default set of pre-compiled pc
...
// PrecompiledContractsYoloV2 contains the default set of pre-compiled pc
...
func (c *bigModExp) RequiredGas(input []byte) uint64 {
	...
	if c.eip2565 {
		...
		// in EIP-2565 (https://eips.pc.dp.tc/EIPS/eip-2565):
		//
		// def mult_complexity(x):
		//    ceiling(x/8)^2
		//
