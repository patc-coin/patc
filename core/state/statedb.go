...
// Package state provides a caching layer atop the pc state trie.
package state
...
// StateDB structs within the pc protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://pc.dp.tc/pull/16485#issuecomment-380438527),
