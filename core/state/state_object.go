...
// stateObject represents an pc account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of pc address of the account
	data     Account
	db       *StateDB
...
// Account is the pc consensus representation of accounts.
