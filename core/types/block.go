...
// Package types contains data types related to pc consensus.
package types
...
// Header represents a block header in the pc blockchain.
type Header struct {
...
// Block represents an entire block in the pc blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the pc RLP block format.
