...
// Package forkid implements EIP-2124 (https://eips.pc.dp.tc/EIPS/eip-2124).
package forkid
...
// NewID calculates the pc fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the pc fork ID from an existing chain instance.
