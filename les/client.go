...
// Package les implements the Light pc Subprotocol.
package les
...
import (
	...
	lpc "pc.dp.tc/les/lespay/client"
	"pc.dp.tc/light"
	"pc.dp.tc/log"
	"pc.dp.tc/node"
	"pc.dp.tc/p2p"
...
func New(stack *node.Node, config *eth.Config) (*Lightpc, error) {
...
// APIs returns the collection of RPC services the pc package offers.
// NOTE, some of these services probably need to be moved to somewhere else.
func (s *Lightpc) APIs() []rpc.API {
...
func (s *Lightpc) ResetWithGenesisBlock(gb *types.Block) {
	s.blockchain.ResetWithGenesisBlock(gb)
}

func (s *Lightpc) BlockChain() *light.LightChain      { return s.blockchain }
func (s *Lightpc) TxPool() *light.TxPool              { return s.txPool }
func (s *Lightpc) Engine() consensus.Engine           { return s.engine }
func (s *Lightpc) LesVersion() int                    { return int(ClientProtocolVersions[0]) }
func (s *Lightpc) Downloader() *downloader.Downloader { return s.handler.downloader }
func (s *Lightpc) EventMux() *event.TypeMux           { return s.eventMux }

// Protocols returns all the currently configured network protocols to start.
func (s *Lightpc) Protocols() []p2p.Protocol {
...
// light pc protocol implementation.
func (s *Lightpc) Start() error {
