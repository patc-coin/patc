...
// Package graphql provides a GraphQL interface to pc node data.
package graphql
...
// Account represents an pc account at a particular block.
type Account struct {
...
// Transaction represents an pc transaction.
...
type CallData struct {
	From     *common.Address // The pc address the call is from.
	To       *common.Address // The pc address the call is to.
