...
// all blocks' seal as valid, though they still have to conform to the pc
// consensus rules.
...
// still have to conform to the pc consensus rules.
...
// they still have to conform to the pc consensus rules.
