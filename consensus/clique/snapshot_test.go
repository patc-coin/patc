...
// mapped from textual names used in the tests below to actual pc private
...
// address retrieves the pc address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the pc address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://pc.dp.tc/issues/17593). Whilst this
