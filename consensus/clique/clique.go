...
// ecrecover extracts the pc account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the pc address
...
// pc testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // pc address of the signing key
...
// Author implements consensus.Engine, returning the pc address recovered
